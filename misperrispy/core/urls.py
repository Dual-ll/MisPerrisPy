...
from .views import index, formularioPerro, formularioPostulante, formularioRescatado, listarPerro, listarPostulante, listarRescatado, eliminarPerro, eliminarPostulante, eliminarRescatado, actualizarPerro, actualizarPostulante, actualizarRescatado
urlpatterns = [
